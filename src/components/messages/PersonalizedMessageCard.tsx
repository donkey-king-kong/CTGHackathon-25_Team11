...
export function PersonalizedMessageCard({ message, onOpen, index, donorName }: PersonalizedMessageCardProps) {
  ...
  return (
    ...
    >
      <Card className={`${gradients[index % gradients.length]} border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden relative`}>
        {/* Personalized Header */}
        ...
        <CardContent className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-medium text-gray-900">{message.child_alias}</p>
                  <div className="flex items-center gap-1 text-xs text-gray-600">
                    <MapPin className="h-3 w-3" />
                    <span>{message.school}, {message.region}</span>
                  </div>
                </div>
              </div>
          ...
          <motion.div 
            ...
            animate={{ y: 0 }}
          >
            <p className="text-xs text-primary font-medium">Click to read the full message 💕</p>
          </motion.div>
        </CardContent>
